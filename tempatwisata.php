      ...
      <div class="container">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Tempat Wisata</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <div class="post-img">
                      <img src="assets/img/blog/pantai-tanjung-labun(2).jpg" alt="" class="img-fluid">
                    </div>

                    <h2 class="title">
                      <a href="tempatwisata1.php">Wisata Pantai Tanjung Labun</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <div class="post-img">
                      <img src="assets/img/blog/camping(2).jpg" alt="" class="img-fluid">
                    </div>

                    <h2 class="title">
                      <a href="tempatwisata2.php">CAMPING DI WISATA PANTAI TANJUNG LABUN</a>
                    </h2>
